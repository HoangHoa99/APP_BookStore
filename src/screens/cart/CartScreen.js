...
export default function CartScreen({ navigation }) {
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            ...
            AsyncStorage.setItem("@cartList", JSON.stringify(updatedCart));
            refresh();
          },
        },
      ],
  ...
  function checkout() {
    if (token._W !== null) {
      ...
      if (checkoutItem.length > 0) {
        console.log('{"product": ' + JSON.stringify(checkoutItem) + "}");
        ...
        fetch("https://utebookstore.herokuapp.com/cart/addfromlg", {
          ...
          .then((status) => {
            ...
            if (status === 200) {
              ...
              AsyncStorage.setItem("@cartList", JSON.stringify(cloneArr));
              refresh();
                  ...
                  >
                    <Image
                      ...
                      style={[
                        ...
                        { height: 70, width: 50, backgroundColor: "#eeeeee" },
                      ]}
                    />
                  </TouchableOpacity>
                  <View
